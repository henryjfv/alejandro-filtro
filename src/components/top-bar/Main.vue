  ...
  <div
    ...
    <div class="h-full flex items-center">
      ...
      <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
        <img alt="Deus Digital" class="logo__image w-6" src="@/assets/images/logo.svg" />
        <span class="logo__text text-white text-lg ml-3"> Deus </span>
      </a>
      <!-- END: Logo -->
      <!-- BEGIN: Breadcrumb -->
      ...
      <!--       <div class="intro-x relative mr-3 sm:mr-6">
        ...
        <div class="search-result" :class="{ show: searchDropdown }">
          <div class="search-result__content">
            ...
            <div class="mb-5">
              <a v-for="(faker, fakerKey) in $_.take($f(), 4)" :key="fakerKey" href class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                  <img alt="Deus Digital" class="rounded-full" :src="faker.photos[0]" />
                </div>
            ...
            <a v-for="(faker, fakerKey) in $_.take($f(), 4)" :key="fakerKey" href class="flex items-center mt-2">
              <div class="w-8 h-8 image-fit">
                <img alt="Deus Digital" class="rounded-full" :src="faker.images[0]" />
              </div>
      ...
      <!--       <Dropdown class="intro-x w-8 h-8">
        <DropdownToggle tag="div" role="button"
          ...
          <img alt="Deus Digital" :src="$f()[9].photos[0]" />
        </DropdownToggle>
